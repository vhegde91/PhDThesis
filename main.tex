...
not a complete theory. The SM is incomplete because it does not explain gravity, dark matter and dark energy in the universe,
...
problem and dark matter problem. In SUSY, every SM particle has a superpartner whose spin differs by half a unit. The masses of 
superpartners are not equal to the SM counterparts which makes SUSY a broken symmetry. There are several ways to break this symmetry and
one of the ways is gauge mediated SUSY breaking (GMSB). If GMSB is realized in nature, it typically results in events with one or more 
