...
\thesistitle{A search for supersymmetry using events with at least one photon, missing transverse momentum, jets and b-jets with the CMS detector} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
A search for supersymmetry signatures is carried out using events containing at least one photon, large missing transverse momentum, jets and (or) b-jets in the final state using the data collected by the CMS detector of the LHC, CERN. The data corresponds to an integrated luminosity of 35.9 \fbinv collected in the year 2016. Observations are consistent with the expectations from the standard model events. Constraints are placed on pair production of gluions and top squarks using simplified supersymmetric models. Gluinos  below 2120 \gev and top squarks below 1230 \gev are excluded at 95\% confidence level, depending on the model and mass of neutralino mass.
