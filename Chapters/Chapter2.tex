...
%\end{figure}
%The search described in this thesis uses data collected by CMS during the proton-proton (pp) collision at a $\sqrt{s}=13$ TeV in the year 
%2016. Total integrated luminosity (\lumi) as delivered by LHC and recorded by the CMS detector as a function of time is shown in 
...
The efficiency of mini-isolation (or any other identification criteria) can be measured using \textit{tag \& probe} (TnP) technique both 
